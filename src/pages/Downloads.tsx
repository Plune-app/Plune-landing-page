    ...
    <div className="relative z-10 max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="space-y-6">
        {releases.map((release, index) => (
          <div
            key={index}
            className={`group p-8 bg-white/10 dark:bg-zinc-800/30 backdrop-blur-md rounded-2xl border border-white/20 dark:border-zinc-700/50 hover:bg-white/20 dark:hover:bg-zinc-800/50 transition-all duration-300 ${release.isLatest ? 'ring-2 ring-zinc-400 dark:ring-zinc-600' : ''
              }`}
          >
